...
struct Tracker::PImpl
{
    ...
    void    prepareSendAnnounce( BufferType& buffer, short port, const Torrent& torrent )
    {
        ...
        LOG_INFO << "Send Announce request with SHA1: " << utility::sha1_to_string( torrent.getHashInfo() );
    ...
    bool    handleAnnounce( BufferType& buffer )
    {
        if ( buffer.size() < 152 )
        {
            LOG_ERROR << "Announce answer incorrect size";
            return false;
        }
        ...
        LOG_INFO << "Peers available: " << peerEndpoints_.size();
        LOG_INFO << "leechers: " << leechers << " | seeders: " << seeders;
    ...
    bool    handleError( BufferType& buffer )
    {
        ...
        LOG_ERROR << "Received error from Tracker: " << buffer.readString( 8 );
        return false;
    }
